...
def RunISHACDE():
    ...
    np.savetxt("./ISHACDE_Data/CEC2017/" + str(DimSize) + "D/F" + str(FuncNum) + ".csv", All_Trial_Best, delimiter=",")
...
if __name__ == "__main__":
    if os.path.exists('ISHACDE_Data/CEC2017/10D') == False:
        os.makedirs('ISHACDE_Data/CEC2017/10D')
    if os.path.exists('ISHACDE_Data/CEC2017/30D') == False:
        os.makedirs('ISHACDE_Data/CEC2017/30D')
    if os.path.exists('ISHACDE_Data/CEC2017/50D') == False:
        os.makedirs('ISHACDE_Data/CEC2017/50D')
    if os.path.exists('ISHACDE_Data/CEC2017/100D') == False:
        os.makedirs('ISHACDE_Data/CEC2017/100D')
    for dim in [100]:
        main(dim)
