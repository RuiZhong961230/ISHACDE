...
def RunISHACDE(func):
    ...
    np.savetxt("./ISHACDE_Data/CEC2014/" + str(DimSize) + "D/F" + str(FuncNum) + ".csv", All_Trial_Best, delimiter=",")
...
def main(Dim):
    ...
    DimSize = Dim
    CEC2014 = [F12014(DimSize), F22014(DimSize), F32014(DimSize), F42014(DimSize), F52014(DimSize),
               F62014(DimSize), F72014(DimSize), F82014(DimSize), F92014(DimSize), F102014(DimSize),
               F122014(DimSize), F132014(DimSize), F142014(DimSize), F152014(DimSize), F162014(DimSize),
               F172014(DimSize), F182014(DimSize), F192014(DimSize), F202014(DimSize), F212014(DimSize),
               F222014(DimSize), F232014(DimSize), F242014(DimSize), F252014(DimSize), F262014(DimSize),
               F272014(DimSize), F282014(DimSize), F292014(DimSize), F302014(DimSize)]
    ...
    for i in range(len(CEC2014)):
        FuncNum = i + 1
        RunISHACDE(CEC2014[i].evaluate)


if __name__ == "__main__":
    if os.path.exists('ISHACDE_Data/CEC2014/10D') == False:
        os.makedirs('ISHACDE_Data/CEC2014/10D')
    if os.path.exists('ISHACDE_Data/CEC2014/30D') == False:
        os.makedirs('ISHACDE_Data/CEC2014/30D')
    if os.path.exists('ISHACDE_Data/CEC2014/50D') == False:
        os.makedirs('ISHACDE_Data/CEC2014/50D')
    if os.path.exists('ISHACDE_Data/CEC2014/100D') == False:
        os.makedirs('ISHACDE_Data/CEC2014/100D')
    for dim in [50, 100]:
        main(dim)
