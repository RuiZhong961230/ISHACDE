...
def RunISHACDE(func):
    ...
    np.savetxt("./ISHACDE_Data/CEC2013/" + str(DimSize) + "D/F" + str(FuncNum) + ".csv", All_Trial_Best, delimiter=",")
...
def main(Dim):
    ...
    DimSize = Dim
    CEC2013 = [F12013(DimSize), F22013(DimSize), F32013(DimSize), F42013(DimSize), F52013(DimSize),
               F62013(DimSize), F72013(DimSize), F82013(DimSize), F92013(DimSize), F102013(DimSize),
               F122013(DimSize), F132013(DimSize), F142013(DimSize), F152013(DimSize), F162013(DimSize),
               F172013(DimSize), F182013(DimSize), F192013(DimSize), F202013(DimSize), F212013(DimSize),
               F222013(DimSize), F232013(DimSize), F242013(DimSize), F252013(DimSize), F262013(DimSize),
               F272013(DimSize), F282013(DimSize)]
    ...
    for i in range(len(CEC2013)):
        FuncNum = i + 1
        RunISHACDE(CEC2013[i].evaluate)


if __name__ == "__main__":
    if os.path.exists('ISHACDE_Data/CEC2013/10D') == False:
        os.makedirs('ISHACDE_Data/CEC2013/10D')
    if os.path.exists('ISHACDE_Data/CEC2013/30D') == False:
        os.makedirs('ISHACDE_Data/CEC2013/30D')
    if os.path.exists('ISHACDE_Data/CEC2013/50D') == False:
        os.makedirs('ISHACDE_Data/CEC2013/50D')
    if os.path.exists('ISHACDE_Data/CEC2013/100D') == False:
        os.makedirs('ISHACDE_Data/CEC2013/100D')
    for dim in [50, 100]:
        main(dim)
